package com.venkatesh.offlinesurveyapp.items.view
...
import com.venkatesh.offlinesurveyapp.items.adapter.ItemRecyclerViewAdapter
...
class ItemListingFragment : Fragment(),KodeinAware {
    ...
    private fun getItemsFromViewModel() {
        if (context != null && context!!.isNetworkAvailable()) {
            ...
            val inputStream = activity?.assets?.open("text_survey.json")
